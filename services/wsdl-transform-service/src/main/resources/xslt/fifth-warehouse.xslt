<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:ns3="http://www.intership.ttsw.com.pl/soap-fifth-warehouse"
                version="1.0"
                exclude-result-prefixes="ns3">
    <xsl:template match="/">
        <ns2:Products>
            <xsl:for-each select="//ns3:WarehouseProduct">
                <ns2:Product>
                    <id>
                    ...
                    <manufacturer>
                        <xsl:value-of select="current()/ns3:producer/ns3:producerName"/>
                    </manufacturer>
